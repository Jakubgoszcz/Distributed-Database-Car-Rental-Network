...
SELECT k.IMIE, k.NAZWISKO, w.CENA, w.DATA_WYPOZYCZENIA from TABLE(pobierz_wszystkich_klientow) k join TABLE(pobierz_wszystkie_wypozyczenia@pd) w on k.KLIENT_ID = w.KLIENT_ID;
